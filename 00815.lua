--¶ÂÂ`_»s¥Ò_110810_¦h¯S¹p
function Lua_110810_RecipeList_Init()

--	SetPlot( OwnerID() , "Touch" , "Lua_110810_RecipeList_Touch" , 60 );
...
AddRecipe( OwnerID(), 551265 ); --Áåº»ÀY¥Ò	
AddRecipe( OwnerID(), 551267 ); --´¹¤ëÃì¥Ò	
AddRecipe( OwnerID(), 551268 ); --´¹¤ëÅ@»L	
AddRecipe( OwnerID(), 551269 ); --°{¬PÅ@»L	
AddRecipe( OwnerID(), 551278 ); --°{¬P¥Ö¥Ò	
AddRecipe( OwnerID(), 551283 ); --±Û­·ñZ¥Ò	
AddRecipe( OwnerID(), 551292 ); --±Û­·ñZÅ@»L	
AddRecipe( OwnerID(), 551297 ); --°{¬P¥ÖÀY´U	
AddRecipe( OwnerID(), 551300 ); --±Û­·ñZÀY²¯	

end

function Lua_110810_RecipeList_Touch()
	closeSpeak( OwnerID() )
