...
function Dy_Z19_BOSSE_AIC()
	...
	local BossDoor2 --後門
	local Bossr
	local Boss = CreateObjByFlag( 105617 , 780696 , 1, 1 ) -- (BOSS編號  ,旗標編號 第N隻旗標 生出幾個怪)
		...
		setplot( Boss , "dead" , "Dy_Z19_BOSSE_DEAD", 0)
		BeginPlot( Boss, "Dy_Z19_BOSSE_AI", 10) ---Boss的戰鬥Function (  BOSS BOSS的LUA_AI  秒\每10=1秒)
		...
		elseif Fight == 2 then --玩家滅團
			...
			sleep(50)
			Boss =CreateObjByFlag( 105617 , 780696 , 1, 1 ) -- (BOSS編號  ,旗標編號 第N隻旗標 生出幾個怪)
			WriteRoleValue( Boss, EM_RoleValue_PID, OwnerID()) --將控制器寫入Boss
			WriteRoleValue( OwnerID(), EM_RoleValue_Register1, Boss) --將Boss寫入控制器
			AddToPartition( Boss , roomID )
			setplot( Boss , "dead" , "Dy_Z19_BOSSE_DEAD", 0) --死亡劇情
			BeginPlot( Boss, "Dy_Z19_BOSSE_AI", 10) ---Boss的戰鬥Function (  BOSS BOSS的LUA_AI  秒\每10=1秒)
			--say(Boss,"123")
			Fight = 0 
			Fight1 = 0
		...
		elseif Fight == 4 then --換完區域的方形傷害隨機
			...
			if Q3 == 0 then --2
				...
				for i = 1 , 3 ,1 do 
					AddBuff ( purple[i], 509534, 0, -1 )
					--刪除509534以外的Buff--
					if CheckBuff(purple[i],  509544 ) == true then
						CancelBuff( purple[i] ,  509544 ) --刪除藍色B-A
						--say (TargetID() , "P_B")
					else
					
					end
					if CheckBuff( TargetID() ,  509546 ) == true then
						CancelBuff( TargetID() ,  509546 ) --刪除藍色B-B
						--say (TargetID() , "P_B")
					else
					
					end
					if CheckBuff( purple[i] ,  509548 ) == true then
						CancelBuff( purple[i] ,  509548  ) --刪除藍色B-C
						--say (TargetID() , "P_B")
					else
					
					end
					if CheckBuff(purple[i] ,  509536 ) == true then
						CancelBuff( purple[i] ,  509536 ) --刪除紫色P-A
						--say (TargetID() , "P_B")
					else
					
					end
					if CheckBuff( purple[i] ,  509538 ) == true then
						CancelBuff( purple[i] ,  509538 ) --刪除紫色P-C
						--say (TargetID() , "P_B")
					else
					
					end
					if CheckBuff( purple[i] ,  509529 ) == true then
						CancelBuff( purple[i] ,  509529 ) --刪除黃昏R-A
						--say (TargetID() , "P_B")
					else
					
					end
					if CheckBuff( purple[i] ,  509527 ) == true then
						CancelBuff( purple[i] ,  509527 ) --刪除黃昏R-B
						--say (TargetID() , "P_B")
					else
					
					end
					if CheckBuff( purple[i] ,  509524 ) == true then
						CancelBuff(purple[i] ,  509524 ) --刪除黃昏R-C
						--say (TargetID() , "P_B")
					else
					
					end
					--
					AddBuff ( blue[i] , 509548 , 0, -1 )
					--刪除509548以外的Buff--
					if CheckBuff( blue[i] ,  509544 ) == true then
						CancelBuff( blue[i] ,  509544 ) --刪除藍色B-A
						--say (TargetID() , "B_C")
					else
					
					end
					if CheckBuff( blue[i] ,  509546 ) == true then
						CancelBuff( blue[i] ,  509546 ) --刪除藍色B-B
						--say (TargetID() , "B_C")
					else
					
					end
					if CheckBuff( blue[i] ,  509536 ) == true then
						CancelBuff( blue[i] ,  509536 ) --刪除紫色P-A
						--say (TargetID() , "B_C")
					else
					
					end
					if CheckBuff( blue[i] ,  509534 ) == true then
						CancelBuff( blue[i] ,  509534 ) --刪除紫色P-B
						--say (TargetID() , "B_C")
					else
					
					end
					if CheckBuff( blue[i] ,  509538 ) == true then
						CancelBuff( blue[i] ,  509538 ) --刪除紫色P-C
						--say (TargetID() , "B_C")
					else
					
					end
					if CheckBuff( blue[i] ,  509529 ) == true then
						CancelBuff( blue[i] ,  509529 ) --刪除黃昏R-A
						--say (TargetID() , "B_C")
					else
					
					end
					if CheckBuff( blue[i] ,  509527 ) == true then
						CancelBuff( blue[i],  509527 ) --刪除黃昏R-B
						--say (TargetID() , "B_C")
					else
					
					end
					if CheckBuff( blue[i] ,  509524 ) == true then
						CancelBuff( blue[i] ,  509524 ) --刪除黃昏R-C
						--say (TargetID() , "B_C")
					else
					
					end					
					--
					AddBuff ( red[i] , 509529, 0, -1 )
					----刪除509529以外的Buff--
					if CheckBuff( red[i]  ,  509544 ) == true then
						CancelBuff( red[i] ,  509544 ) --刪除藍色B-A
						--say (TargetID() , "R_A")
					else
					
					end
					if CheckBuff( red[i] ,  509546 ) == true then
						CancelBuff( red[i]  ,  509546 ) --刪除藍色B-B
						--say (TargetID() , "R_A")
					else
					
					end
					if CheckBuff( red[i]  ,  509548 ) == true then
						CancelBuff( red[i]  ,  509548  ) --刪除藍色B-C
						--say (TargetID() , "R_A")
					else
					
					end
					if CheckBuff( red[i]  ,  509536 ) == true then
						CancelBuff( red[i]  ,  509536 ) --刪除紫色P-A
						--say (TargetID() , "R_A")
					else
					
					end
					if CheckBuff( red[i]  ,  509534 ) == true then
						CancelBuff( red[i]  ,  509534 ) --刪除紫色P-B
						--say (TargetID() , "R_A")
					else
					
					end
					if CheckBuff(red[i]  ,  509538 ) == true then
						CancelBuff( red[i]  ,  509538 ) --刪除紫色P-C
						--say (TargetID() , "R_A")
					else
					
					end
					if CheckBuff( red[i]  ,  509527 ) == true then
						CancelBuff( red[i]  ,  509527 ) --刪除黃昏R-B
						--say (TargetID() , "R_A")
					else
					
					end
					if CheckBuff( red[i]  ,  509524 ) == true then
						CancelBuff( red[i]  ,  509524 ) --刪除黃昏R-C
						--say (TargetID() , "R_A")
					else
			...
			elseif Q3 == 1 then --4
				...
				--刪除509536以外的Buff--
					...
					if CheckBuff( purple[i] ,  509546 ) == true then
						CancelBuff( purple[i] ,  509546 ) --刪除藍色B-B
						--say (TargetID() , "P_A")
					else
					...
					if CheckBuff( purple[i] ,  509534 ) == true then
						CancelBuff( purple[i] ,  509534 ) --刪除紫色P-B
						--say (TargetID() , "P_A")
					else
				...
				--
					...
					--刪除509546以外的Buff--
						...
						if CheckBuff( blue[i] ,  509548 ) == true then
							CancelBuff( blue[i] ,  509548  ) --刪除藍色B-C
							--say (TargetID() , "B_B")
						else
					...
					--刪除509524以外的Buff--
						...
						if CheckBuff( red[i] ,  509529 ) == true then
							CancelBuff( red[i] ,  509529 ) --刪除黃昏R-A
							--say (TargetID() , "R_C")
						else
			...
			elseif Q3 == 4 then --6
				...
				--刪除509544以外的Buff--
					...
					if CheckBuff( blue[i] ,  509529 ) == true then
						CancelBuff( Tblue[i] ,  509529 ) --刪除黃昏R-A
						--say (TargetID() , "B_A")
					else
