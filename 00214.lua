...
--控制對話內容--
	if ( ReadRoleValue(OwnerID(), EM_RoleValue_SkillMax_Cook  ) >= 80 )  then --檢查有大師以上資格的話
		SetSpeakDetail( OwnerID(), GetString ( "ST_110388_5" )   );--#站住！讓我好好的欣賞你～真是傑作啊！喔～我不是在欣賞你的衣服，而是你身為頂級廚師的魂魄啊！看不到嗎？那如火焰般燃燒的靈魂！
	elseif ( ReadRoleValue( OwnerID() , EM_RoleValue_Skill_Cook ) == 60 ) then  --等級60提示要玩家去黑曜石要塞
		SetSpeakDetail( OwnerID(), GetString ( "ST_110388_4" )   );--#喔！讚嘆吧！你散發出來的氣質～那已經足以向烹飪大師學習極至的藝術！但你要知道，這個層次的藝術沒那麼容易達到，你必須先找到烹飪大師，而現在這個世界只有黑曜石要塞還殘留了一些他的謠言而已。
	elseif ReadRoleValue( OwnerID() , EM_RoleValue_Skill_Cook  ) >= 40  then --等級大於40則叫玩家去找另一個NPC
		SetSpeakDetail( OwnerID(), GetString ( "ST_110388_3" )   );--#酷斃了！現在你掌握食物的能力已經火侯十足了！你應該去向卡爾迪西先生請教，去學習他的藝術吧！
	elseif(    ReadRoleValue( OwnerID() , EM_RoleValue_Skill_Cook  ) == 20 ) then  --等級等於20時判斷是否可接任務
		...
		SetSpeakDetail( OwnerID(), GetString("ST_110388_0")   );--/*太美味了！我的人生就是為了追求極至的美味，你也想與我一起來向這美好的目標邁進嗎？
	end

--控制對話選項--
	if( ReadRoleValue ( OwnerID(), EM_RoleValue_SkillMax_Cook ) >= 40) then
		AddSpeakOption( OwnerID(), TargetID( ), GetString("SO_DEGRADE_DIALOG") , "LuaS_110388_2", 0 ) --/*我想放棄目前的資格
	...
	if ( ReadRoleValue( OwnerID() , EM_RoleValue_SkillMax_Cook ) > 0) then --如果會烹飪
		...
		AddSpeakOption( OwnerID(), TargetID( ), GetString("SO_110388_1") , "LuaS_110388_1", 0 );	--/*我想學習烹飪。
	end

--常態對話選項--
	AddSpeakOption( OwnerID(), TargetID( ), GetString("SO_FORMULA_STORE") , "Lua_110388_RecipeList_Touch", 0 )  --/*我想看看你賣的配方。--讓不會的人也能看看能做什麼東西	
...
function LuaS_110388_2()
	...
	AddSpeakOption( OwnerID(), TargetID( ), GetString("SO_GETVOC_NO"), "LuaS_110388_0", 0 ); --/*我再考慮看看。
