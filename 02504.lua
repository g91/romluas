...
function Lua_ZonePE_Z21_Global()--變數宣告(每個區域變更)
	...
	Global["Shop"][4] = 600375	--高級商店(參觀
	Global["Shop"][5] = 600376	--中級物防商店(參觀
	Global["Shop"][6] = 600377	--中級命中商店(參觀


	Global["PE_Name"] = "SC_ZONE_PE_Z21_NAME"--PE名稱
	Global["PE_Desc"] = "SC_ZONE_PE_Z21_DESC"--PE描述
	Global["PH_Name"] = {}--階段名稱
	Global["PH_Name"][1] = "SC_ZONE_PE_Z21_PHNAME01"	-- 等待階段
	Global["PH_Name"][2] = "SC_ZONE_PE_Z21_PHNAME02"	-- 進行階段
	
	Global["PH_Desc"] = {}--階段描述
	Global["PH_Desc"][1] = "SC_ZONE_PE_Z21_DESC01"-- 等待描述
	Global["PH_Desc"][2] = "SC_ZONE_PE_Z21_DESC02"-- 進行描述
	
	Global["OB_Name"] = "SC_ZONE_PE_Z21_OBNAME"--進行階段成功條件
