function lua_kenny_AI_blood2()
		local Check_pet = 0  ---判斷寵物進入戰鬥用
		local SkillID = {493720,493721,493722,494193,493724,493725} 	--血之暈技，血之耖魔，血之破甲，血之治療無效，血之噬血箭
				...
				Blood_cast = DW_HateRemain(0) --仇恨表全抓
					...
					for	i=1,j,1	do	
						...
						if	CheckBuff(PlayerID[i], BloodBuffID ) == true and PlayerID[i] ~= nil then	--對有buff的人出一隻血字大軍														
							...
							---	setplot(Blood1_1 , "Dead" , "lua_kenny_Blood_dead_04" , 50 )	--血色大軍死亡劇情
								
								setplot(Blood1_1 , "Dead" , "Lua_kenny_delobj" , 50 )	--血色大軍死亡刪除
...
function lua_kenny_Blood_dead_04()	--殺掉血色大軍扣boss的血量
