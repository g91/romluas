...
--建立者  : 活動企劃 潘晉佳
------------------------------------------------------------------------------
--掛在 任務NPC   (3號  MI)  112773  CODE
------------------------------------------------------------------------------
function LuaN_musicfes_112773_range()  
		SetPlot( OwnerID(), "touch", "LuaN_musicfes_112773_sing", 50 );
end
------------------------------------------------------------------------------
function LuaN_musicfes_112773_sing()
	...
	PlaySoundToPlayer( OwnerID() , "sound/sound_new/skill/Music_Festival/scale/3.mp3", false )

		if Qhard01 == true then --Q困難1  10.8.7.6
			if step11 == true or step10 == true or step08 == true or step04 == true or step03 == true or step02 == true or step01 == true or step00 == true then
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG03]", C_SYSTEM )--MI~
				Sleep(10) --2秒
		...
		elseif Qhard02 == true then --Q困難2  7 5 4 2 1
			if step11 == true or step10 == true or step09 == true or step08 == true or step07 == true or step05 == true or step02 == true then
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG03]", C_SYSTEM )--MI~
				Sleep(10) --2秒
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG_WRONG]", C_SYSTEM )--你答錯囉！請重新來過吧！
				SetFlag( OwnerID()  , 542531 , 0 ) -- 刪旗標1
					...
					if step04 == true then -- 如果有step 04
						...
						if step03 == true then -- 如果有step 03
							...
							if step01 == true then -- 如果有step 01
								...
								if step00 == true then -- 如果有step 00
									ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG03]", C_SYSTEM )--MI~
									Sleep(10) --2秒
									ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG_RIGHT]", C_SYSTEM )--你答對囉，繼續保持下去吧！
		...
		elseif Qhard03 == true then --Q困難3  6
			if step11 == true or step10 == true or step09 == true or step08 == true or step07== true or step06== true or step04== true or step03 == true or step02 == true or step01 == true or step00 == true then
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG03]", C_SYSTEM )--MI~
				Sleep(10) --2秒
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG_WRONG]", C_SYSTEM )--你答錯囉！請重新來過吧！
				SetFlag( OwnerID()  , 542531 , 0 ) -- 刪旗標1
		...
		elseif Qeasy01 == true then --Q簡單1   7 , 5, 3
			if step05 == true or step03 == true or step01 == true or step00 == true then
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG03]", C_SYSTEM )--MI~
				Sleep(10) --2秒
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG_WRONG]", C_SYSTEM )--你答錯囉！請重新來過吧！
				SetFlag( OwnerID()  , 542531 , 0 ) -- 刪旗標1
				...
				if step06 == true then -- 如果有step 06
					...
					SetFlag( OwnerID()  , 542542 , 0 ) -- 刪 接下挑戰簡單Q1		
					SetFlag( OwnerID()  , 542536 , 0 ) -- 刪 Flag Q06
		...
		elseif Qeasy02 == true then --Q簡單2 x
			...
			SetFlag( OwnerID()  , 542541 , 0 ) -- 刪旗標11
			SetFlag( OwnerID()  , 542530 , 1 ) -- 給旗標0
		elseif Qeasy03 == true then --Q簡單2     3
			if step06 == true or step05 == true or step04 == true or step03 == true or step01 == true or step00 == true then
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG03]", C_SYSTEM )--MI~
				Sleep(10) --2秒
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG_WRONG]", C_SYSTEM )--你答錯囉！請重新來過吧！
				SetFlag( OwnerID()  , 542531 , 0 ) -- 刪旗標1
