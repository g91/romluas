function LuaI_110930_1()
	...
	local sting = CreateObj( 100672,BaseX+30, BaseY, BaseZ, BaseDir+180 , 1 )
	local sting1 = CreateObj( 100672,BaseX, BaseY, BaseZ+30, BaseDir+180 , 1 )
	local sting2 = CreateObj( 100672,BaseX-30, BaseY, BaseZ, BaseDir+180 , 1 )
	local sting3 = CreateObj( 100672,BaseX, BaseY, BaseZ-30, BaseDir+180 , 1 )
	local sting4 =0
	local sting5 =0
	local helper = CreateObj(100671, BaseX, BaseY, BaseZ, BaseDir, 1 )		
	...
	if tempa >3 then --亂數多2之
		sting4 = CreateObj( 100672,BaseX+50, BaseY, BaseZ, BaseDir+180 , 1 )
		sting5 = CreateObj( 100672,BaseX-50, BaseY, BaseZ, BaseDir+180 , 1 )
