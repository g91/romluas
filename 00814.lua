--¶ÂÂ`_²i¶¹_110812_¦Ì¶®
function Lua_110812_RecipeList_Init()

--	SetPlot( OwnerID() , "Touch" , "Lua_110812_RecipeList_Touch" , 60 );
...
AddRecipe( OwnerID(), 551225); --²½¨å¸tÀ\
AddRecipe( OwnerID(), 551227); --¹Ú¹Ò¤§ªG

end

function Lua_110812_RecipeList_Touch()
	closeSpeak( OwnerID() )
