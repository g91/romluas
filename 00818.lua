--¶ÂÂ`_µôÁ__110813_¬À¯S
function Lua_110813_RecipeList_Init()
--	SetPlot( OwnerID() , "Touch" , "Lua_110813_RecipeList_Touch" , 60 );
...
AddRecipe( OwnerID(), 551261 ); --¬P«a	
AddRecipe( OwnerID(), 551263 ); --Às¯¾¦ç	
AddRecipe( OwnerID(), 551264 ); --Às¯¾¿Ç	
AddRecipe( OwnerID(), 551272 ); --±m´¹©Ü­·	

end

function Lua_110813_RecipeList_Touch()
	closeSpeak( OwnerID() )
