function SetEq_Knight_Lv55()
	...
	--設定玩家裝備
	Obj:SetEq( EM_EQWearPos_Head , 220694 );
	Obj:SetEq( EM_EQWearPos_Gloves , 220741 );
	Obj:SetEq( EM_EQWearPos_Shoes , 220750 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220707 );
	Obj:SetEq( EM_EQWearPos_Pants , 220729 );
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220719 );
	Obj:SetEq( EM_EQWearPos_Shoulder, 220760 );
