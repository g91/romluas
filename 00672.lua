function SongSong_Bag_LVEX18( Option )

	local PlayerID = OwnerID()
	local PackageID = 201875		-- 藍色好運禮包
	local NeedSpace = 1
	...
	-- 防具
	local ArmorGroup = { 221707 , 221707 , 221707 , 221707 , 221707 , 221707 }		-- 戰士、遊俠、影行、法師、祭司、騎士
	-- 飾品
...
function SongSong_Bag_LVEX20( Option )

	local PlayerID = OwnerID()
	local PackageID = 201876		-- 藍色好運禮包
	local NeedSpace = 1
	local NeedSpaceStatus  = Check_Bag_Space( PlayerID , NeedSpace  )
	...
	local WeaponGroup = {  }		-- 戰士、遊俠、影行、法師、祭司、騎士
	-- 防具
	local ArmorGroup = { 221708 , 221708 , 221708 , 221708 , 221708 , 221708 }		-- 戰士、遊俠、影行、法師、祭司、騎士
	-- 飾品
	local AccessGroup = {  }		-- 戰士、遊俠、影行、法師、祭司、騎士
	-- 藥水
	local HPPotionGroup = { 0 , 0 , 0 , 0 , 0 , 0 }					-- 戰士、遊俠、影行、法師、祭司、騎士
