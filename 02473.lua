function ic_106028_02()   																	 ---王AI(第10固定狂暴用)
		...
		while 1 do
			...
			if time4==1 then---大絕
				while 	ReadRoleValue(OwnerID() , EM_RoleValue_SpellMagicID  ) ~= 0   do--------有沒有正在施放技能
					...
					CastSpellLV( Boss ,Boss, 498284 ,5)
					Sleep(30)
			...
			if time8>=27 then
				...
				CastSpellLV( Boss ,Boss, 498375 ,2)
				sleep(60)
				time8=0
			end
			if time3>=25 or time3>=5 and time5==1 then---影分身
				...
				if playKKboss==1 then
						...
						mobkk1=bosskkpaly[1]
						mob1=CreateObj(106029,XBoss,YBoss,ZBoss,0,1)---分身1
						mob2=CreateObj(106030,XBoss,YBoss,ZBoss,0,1)---分身1
						--mob3=CreateObj(106031,XBoss,YBoss,ZBoss,0,1)---分身1
						...
						BeginPlot(mob1 , "ic_106028_mob44" , 0)
						BeginPlot(mob2 , "ic_106028_mob44" , 0)
						--BeginPlot(mob3 , "ic_106028_mob44" , 0)
						SetModeEx( Boss , EM_SetModeType_Move, true) 							---移動
						time3=0
						time5=2
			...
			if time2>=15 or time2>=2 and time5==0 then---注入靈氣給石住
				while 	ReadRoleValue(OwnerID() , EM_RoleValue_SpellMagicID  ) ~= 0   do--------有沒有正在施放技能
					...
					CastSpellLV( Boss ,Boss, 497600 ,49)
					Sleep(20)
...
function ic_106028_mob44()---影分身技能
...
local mobkk1
	while 1 do
		...
		if time2>=5 and playjob==1 or time2>=5 and playjob==2 or time2>=5 and playjob==3 or time2>=5 and playjob==6 or time2>=5 and playjob==7 or time2>=7 and playjob==10 then --物理職業
			...
			CastSpellLV( OwnerID(),AttackTarget, 497605,5)						
			Sleep(20)
		...
		elseif 	time2>=5 and playjob==4 or time2>=5 and playjob==5 or time2>=5 and playjob==8 or time2>=7 and playjob==9 then	--法術職業
			SetModeEx( OwnerID() , EM_SetModeType_Move, false) 							---移動
			CastSpellLV( OwnerID(),AttackTarget, 497604,300)						
			Sleep(20)
			SetModeEx( OwnerID() , EM_SetModeType_Move, true) 							---移動
			time2=0
		end
