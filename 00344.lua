function SetEq_Warrior_Lv70()
	...
	--設定玩家裝備
	Obj:SetEq( EM_EQWearPos_Head , 220223 );
	Obj:SetEq( EM_EQWearPos_Gloves , 220306 );
	Obj:SetEq( EM_EQWearPos_Shoes , 220323 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220247  );
	Obj:SetEq( EM_EQWearPos_Pants , 220289 );
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220266 );
