...
function LuaS_110728_1()
	...
	AddSpeakOption( OwnerID(), TargetID( ), GetString("SO_BACKTALK") , "LuaS_110728_0", 0 ); 	--我想回到剛剛的對話
--	AddSpeakOption( OwnerID(), TargetID( ), GetString("SO_EXIT") , "LuaS_110728_EXIT",  0 );	--離開
...
function LuaS_110728_5()
	...
	if (SHP == true) then
		...
		ScriptMessage( OwnerID(), OwnerID(), 2, GetString("ST_TRANSFER_8")  , C_SYSTEM )	--畫面中間訊息：您將回程地點登記在凡瑞娜絲城城下西區！
		ScriptMessage( OwnerID(), OwnerID(), 0, GetString("ST_TRANSFER_8") , 0 )	--您將回程地點登記在凡瑞娜絲城城下西區！
	else
