...
function LuaI_103266_dead() --戈爾帝姆
	local RoomID = ReadRoleValue( OwnerID() , EM_RoleValue_RoomID )
...
function LuaI_103205_dead() --瓦爾哈拉
	local RoomID = ReadRoleValue( OwnerID() , EM_RoleValue_RoomID )
...
function LuaI_103212_dead() --安德弗利姆
	local RoomID = ReadRoleValue( OwnerID() , EM_RoleValue_RoomID )
