function SetEq_Mage_Lv5()
	...
	Obj:SetEq( EM_EQWearPos_Shoes , 220193 );	--布衣
	Obj:SetEq( EM_EQWearPos_Clothes , 220098 );	--布衣
	Obj:SetEq( EM_EQWearPos_Pants , 220147 );	--布衣
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220126 );	--布衣
	...
	Obj:SetEq( EM_EQWearPos_MainHand, 210140 );
