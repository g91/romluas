function SetEq_Warrior_Lv35()
	...
	Obj:SetEq( EM_EQWearPos_Gloves , 220299  );
	Obj:SetEq( EM_EQWearPos_Shoes , 220316 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220237  );
	Obj:SetEq( EM_EQWearPos_Pants , 220279 );
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220259 );
	...
	Obj:SetEq( EM_EQWearPos_MainHand, 210211 );
