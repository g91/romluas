...
function ic_105641_mob()																	---石住走路用---12人-簡單都一樣AI
local isaac=ReadRoleValue(OwnerID(),EM_RoleValue_PID)
...
function ic_105641_bossnokk()																---不攻擊GM---12人-簡單都一樣AI
		if ReadRoleValue(TargetID() , EM_RoleValue_VOC ) ~= 0 and CheckBuff( TargetID(), 509634 ) == false  then 
			return true
		elseif ReadRoleValue(TargetID() , EM_RoleValue_VOC ) ==0 then 
			return false
		elseif CheckBuff( TargetID(), 509634 ) == true then  
			return false
		end
end									
function ic_105641_nokk() 																	--點石棺---12人-簡單都一樣AI		
local RoomID=ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
local npc=TargetID()
local time1=0
local time2=0
...
function ic_105641_mobonkk() 																--觸發--對話(物品)真符文---12人-簡單都一樣AI		
local RoomID=ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
local npc=TargetID()
local time1
SetPlot(npc,"touch","",0)
...
function ic_105641_mobonkkk() 																--觸發--對話(物品)假符文---12人-簡單都一樣AI		
local RoomID=ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
local npc=TargetID()
local time1=0
	if time1==0 then
...
function ic_105641_01()  																	---第10口袋固定死亡劇情用--第9口袋固定測試距離用					--say(OwnerID(),"boss44="..boss44)														
	...
	local Boss=CreateObjByFlag(105641,780934,1,1) 											---BOSS創在  旗標1
	...
	SetModeEx( Boss , EM_SetModeType_Fight, false) 						---可砍殺
		mob1=CreateObjByFlag(105643,780934,51,1)
		...
		mob2=CreateObjByFlag(105644,780934,52,1)
		...
		mob3=CreateObjByFlag(105645,780934,53,1)
		...
		mob4=CreateObjByFlag(105646,780934,54,1)
		...
		if Luck1==1 or Luck1==3 or Luck1==5 then	---12人-簡單都一樣AI
			SetPlot(mob01,"touch","ic_105641_mobonkk",5)
			SetPlot(mob02,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob03,"touch","ic_105641_mobonkk",5)
			SetPlot(mob04,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob05,"touch","ic_105641_mobonkk",5)
			SetPlot(mob06,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob07,"touch","ic_105641_mobonkk",5)
			SetPlot(mob08,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob09,"touch","ic_105641_mobonkk",5)
			SetPlot(mob010,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob011,"touch","ic_105641_mobonkk",5)
			SetPlot(mob012,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob013,"touch","ic_105641_mobonkk",5)
			SetPlot(mob014,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob015,"touch","ic_105641_mobonkk",5)
			SetPlot(mob016,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob017,"touch","ic_105641_mobonkk",5)
			SetPlot(mob018,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob019,"touch","ic_105641_mobonkk",5)
			SetPlot(mob020,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob021,"touch","ic_105641_mobonkk",5)
			SetPlot(mob022,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob023,"touch","ic_105641_mobonkk",5)
			SetPlot(mob024,"touch","ic_105641_mobonkkk",5)
		elseif Luck1==2 or Luck1==4 or Luck1==6 then	---12人-簡單都一樣AI
			SetPlot(mob01,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob02,"touch","ic_105641_mobonkk",5)
			SetPlot(mob03,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob04,"touch","ic_105641_mobonkk",5)
			SetPlot(mob05,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob06,"touch","ic_105641_mobonkk",5)
			SetPlot(mob07,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob08,"touch","ic_105641_mobonkk",5)
			SetPlot(mob09,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob010,"touch","ic_105641_mobonkk",5)
			SetPlot(mob011,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob012,"touch","ic_105641_mobonkk",5)
			SetPlot(mob013,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob014,"touch","ic_105641_mobonkk",5)
			SetPlot(mob015,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob016,"touch","ic_105641_mobonkk",5)
			SetPlot(mob017,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob018,"touch","ic_105641_mobonkk",5)
			SetPlot(mob019,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob020,"touch","ic_105641_mobonkk",5)
			SetPlot(mob021,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob022,"touch","ic_105641_mobonkk",5)
			SetPlot(mob023,"touch","ic_105641_mobonkkk",5)
			SetPlot(mob024,"touch","ic_105641_mobonkk",5)
		end
		...
		SetPlot( Boss,"dead","ic_105641_BOSSXX",0 )											---掛死亡劇情---12人-簡單都一樣AI
		SetPlot(NPC,"touch","ic_105641_nokk",20)
		...
		HPPercent = NowHP / MaxHP
			...
			if hatelistcount(boss)~=0 then    												---讀仇恨人數
				...
				if mob9898==1 and time1==0 then												--- 叫石住走路
					...
					if HPPercent>0.6 then
						Luck=DW_Rand(6)
						if Luck==1 then
							AddBuff(mob1,509621,999 ,-1 )
							AddBuff(mob3,509623,999 ,-1 )
							SetModeEx( mob1 , EM_SetModeType_Fight, true) 										---可砍殺
							SetModeEx( mob3 , EM_SetModeType_Fight, true) 										---可砍殺
						elseif Luck==2 then
							AddBuff(mob2,509622,999 ,-1 )
							AddBuff(mob4,509624,999 ,-1 )
				...
				Boss100=Lua_DW_CreateObj("flag",104693,780934,1,0)							---測試距離用
					...
					BeginPlot(Boss100 , "ic_105641_100" , 0)								---測試距離---12人-簡單都一樣AI	
					...
					BeginPlot(boss , "ic_105641_02" , 0)									---命令角色做事情
					BeginPlot(mob1 , "ic_105641_mob" , 0)									---命令角色做事情---12人-簡單都一樣AI
					BeginPlot(mob2 , "ic_105641_mob" , 0)									---命令角色做事情---12人-簡單都一樣AI
					BeginPlot(mob3 , "ic_105641_mob" , 0)									---命令角色做事情---12人-簡單都一樣AI
					BeginPlot(mob4 , "ic_105641_mob" , 0)									---命令角色做事情---12人-簡單都一樣AI
			...
			if hatelistcount(boss)==0 and open==1 or BOSS9898==1 and open==1 then										---開戰後仇恨表沒人
				if ReadRoleValue( boss , EM_RoleValue_IsDead)==0 then   					---王沒死 玩家滅團
					...
					SetModeEx( NPC , EM_SetModeType_SearchenemyIgnore, false)							---是否被搜尋(否) 
					AddToPartition(NPC,RoomID)
					SetPlot(NPC,"touch","ic_105641_nokk",20)										---12人-簡單都一樣AI
					WriteRoleValue(mob1,EM_RoleValue_register2,1)
					WriteRoleValue(mob2,EM_RoleValue_register2,2)
					WriteRoleValue(mob3,EM_RoleValue_register2,3)
					WriteRoleValue(mob4,EM_RoleValue_register2,4)
					...
					WriteRoleValue(mob3,EM_RoleValue_PID,isaac)
					WriteRoleValue(mob4,EM_RoleValue_PID,isaac)
					Boss=CreateObjByFlag(105641,780934,1,1)           						---再創造1之	
					...
					WriteRoleValue(mob3,EM_RoleValue_register8,BOSS)
					WriteRoleValue(mob4,EM_RoleValue_register8,BOSS)
					BeginPlot(isaac, "ic_105641_BUFFXX" , 0)								---刪除BUFF
					time1=0
					time2=0
					time3=0
					mob9898=0	
...
function ic_105641_BUFFXX()																	---刪除BUFF用
	local RoomID=ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
