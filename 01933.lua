--達城_挖礦_115960_拉芮絲．普洛托


function Lua_115960_RecipeList_Init()
...
AddRecipe( OwnerID(), 551620 ); --配方-鐵橄欖石砂
...
AddRecipe( OwnerID(), 551621 ); --配方-鐵橄欖石塊

AddRecipe( OwnerID(), 550021 ); --配方-黃銅錠
AddRecipe( OwnerID(), 550022 ); --配方-錫錠
AddRecipe( OwnerID(), 550023 ); --配方-赤鐵錠
AddRecipe( OwnerID(), 550024 ); --配方-紫銅錠
AddRecipe( OwnerID(), 550025 ); --配方-闇晶錠
AddRecipe( OwnerID(), 550026 ); --配方-白銀錠
AddRecipe( OwnerID(), 550027 ); --配方-巫鐵錠
AddRecipe( OwnerID(), 550028 ); --配方-祕銀錠
AddRecipe( OwnerID(), 550029 ); --配方-深淵水銀錠
AddRecipe( OwnerID(), 550030 ); --配方-符文黑曜錠
AddRecipe( OwnerID(), 551622 ); --配方-鐵橄欖石碇
--AddRecipe( OwnerID(), 551623 ); --配方-淬煉鐵橄欖石碇
--AddRecipe( OwnerID(), 551624 ); --配方-寒岩結晶錠
...
AddRecipe( OwnerID(), 550157 ); --配方-海神雲母砂61
...
AddRecipe( OwnerID(), 550165 ); --配方-火焰塵錠
AddRecipe( OwnerID(), 550166 ); --配方-藍冰石錠
AddRecipe( OwnerID(), 550167 ); --配方-大水晶錠
AddRecipe( OwnerID(), 550168 ); --配方-奧利哈爾錠
AddRecipe( OwnerID(), 550169 ); --配方-米斯里魯錠
AddRecipe( OwnerID(), 550170 ); --配方-寒岩結晶錠
AddRecipe( OwnerID(), 550171 ); --配方-海神雲母錠
...
AddRecipe( OwnerID(), 552317  ); --	配方-符文黑曜塊	56
AddRecipe( OwnerID(), 552318  ); --	配方-符文黑曜錠	56
AddRecipe( OwnerID(), 552327  ); --	配方-海神雲母塊	61
AddRecipe( OwnerID(), 552328  ); --	配方-海神雲母錠	61
AddRecipe( OwnerID(), 552329  ); --	配方-鐵橄欖石塊	61
AddRecipe( OwnerID(), 552330  ); --	配方-鐵橄欖石碇	61
