function SetEq_Warrior_Lv10()
	...
	Obj:SetEq( EM_EQWearPos_Shoes , 220311 );
	--Obj:SetEq( EM_EQWearPos_Clothes , 220230  );	--HQ上衣
	Obj:SetEq( EM_EQWearPos_Clothes , 220229  );
	Obj:SetEq( EM_EQWearPos_Pants , 220271 );
	--Obj:SetEq( EM_EQWearPos_Pants , 220272 );	--HQ褲子
	...
	Obj:SetEq( EM_EQWearPos_MainHand, 210085 );
