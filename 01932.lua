...
function Lua_115961_RecipeList_Init()
...
AddRecipe( OwnerID(), 551610 ); --配方-法斯坦巨榕木材
...
AddRecipe( OwnerID(), 551611 ); --配方-法斯坦巨榕木條

AddRecipe( OwnerID(), 550071 ); --配方-輕木板
AddRecipe( OwnerID(), 550072 ); --配方-柳木板
AddRecipe( OwnerID(), 550073 ); --配方-楓木板
AddRecipe( OwnerID(), 550074 ); --配方-橡木板
AddRecipe( OwnerID(), 550075 ); --配方-青斑松板
AddRecipe( OwnerID(), 550076 ); --配方-冬青木板
AddRecipe( OwnerID(), 550077 ); --配方-紫杉木板
AddRecipe( OwnerID(), 550078 ); --配方-塔斯林魔木板
AddRecipe( OwnerID(), 550079 ); --配方-龍巢巨木板
AddRecipe( OwnerID(), 550080 ); --配方-古靈橡樹板
AddRecipe( OwnerID(), 551612 ); --配方-法斯坦巨榕木板
--AddRecipe( OwnerID(), 551613 ); --配方-精緻法斯坦巨榕木板
--AddRecipe( OwnerID(), 551614 ); --配方-頂級法斯坦巨榕木板
...
AddRecipe( OwnerID(), 552367   ); --	配方-古靈橡樹條	56
AddRecipe( OwnerID(), 552368   ); --	配方-古靈橡樹板	56
AddRecipe( OwnerID(), 552369   ); --	配方-遠古木條	61
AddRecipe( OwnerID(), 552370   ); --	配方-遠古木板	61
AddRecipe( OwnerID(), 552371   ); --	配方-法斯坦巨榕木條	61
AddRecipe( OwnerID(), 552372   ); --	配方-法斯坦巨榕木板	61

end
function Lua_Com_SpeakOpenRecipeList()
	closeSpeak( OwnerID() )
