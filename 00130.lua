function SetEq_Ranger_Lv15()
	...
	Obj:SetEq( EM_EQWearPos_Gloves , 220175  );
	Obj:SetEq( EM_EQWearPos_Shoes , 220196 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220102  );
	Obj:SetEq( EM_EQWearPos_Pants , 220151 );
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220129 );
	...
	Obj:SetEq( EM_EQWearPos_MainHand, 210086 );
