...
function LuaS_117449_0()
	...
	LoadQuestOption(Obj)
	AddSpeakOption ( Obj, TargetID( ), "[SC_111454_12]" , "LuaS_117449_2", 0 ) 	--我很擔心自己的前途，我將可以學到什麼技能？
	AddSpeakOption(Obj,Obj,"[SC_111454_3]","LuaS_117449_1", 0 )--我要學習新的技能
	AddSpeakOption(Obj,Obj,"[SC_111454_10]","LuaS_117449_5", 0 ) --我想知道取得技能學習證書的方法。
end
...
function LuaS_117449_1()
	...
	BookCondition = DW_EliteSkill_ItemNum(CheckResult) --需要證書編號
...
--學習
	CloseSpeak(Obj)
	DelBodyItem(Obj,BookCondition,1)--刪除證書
