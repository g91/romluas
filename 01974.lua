function Lua_Az133_Statue_Ctrl()
	...
	BeginPlot(Trap,"Lua_Az133_Statue_ATT",0)
	...
	BeginPlot(Statue1,"Lua_Az133_Statue_NON",0)
	say(Statue1,"1")
	...
	BeginPlot(Statue2,"Lua_Az133_Statue_MOV",0)
	say(Statue2,"2")
	table.remove(Flag,FlagRND)
	Flags=table.getn(Flag)
	FlagRND=DW_Rand(Flags)
	...
	BeginPlot(Statue3,"Lua_Az133_Statue_CLK",0)
	say(Statue3,"3")
	table.remove(Flag,FlagRND)
	Flags=table.getn(Flag)
	FlagRND=DW_Rand(Flags)
	...
	BeginPlot(Statue4,"Lua_Az133_Statue_RNG",0)
	say(Statue4,"4")
	--寫死的
	...
	--WriteRoleValue(Statue4,EM_RoleValue_register2,0)
	BeginPlot(Statue15,"Lua_Az133_Statue_15",0)
	...
	BeginPlot(Statue10,"Lua_Az133_Statue_10",0)
	...
	--WriteRoleValue(Statue10,EM_RoleValue_register2,0)
	BeginPlot(Statue12,"Lua_Az133_Statue_12",0)
	...
	--WriteRoleValue(Statue4,EM_RoleValue_register2,0)
	BeginPlot(Statue16,"Lua_Az133_Statue_16",0)
	...
	--WriteRoleValue(Statue4,EM_RoleValue_register2,0)
	BeginPlot(Statue14,"Lua_Az133_Statue_14",0)
	...
	--WriteRoleValue(Statue4,EM_RoleValue_register2,0)
	BeginPlot(Statue17,"Lua_Az133_Statue_17",0)
	...
	say(cloud,"111")
	beginplot(cloud,"Lua_Az133_LightingCould",0)
end
	
function Lua_Az133_Statue_NON()
	SetPlot(OwnerID(),"touch","Lua_Az133_Statue1",50)
end

function Lua_Az133_Statue_MOV()
	SetPlot(OwnerID(),"touch","Lua_Az133_Statue2",50)
end

function Lua_Az133_Statue_CLK()
	SetPlot(OwnerID(),"touch","Lua_Az133_Statue3",50)
end

function Lua_Az133_Statue_RNG()
	SetPlot(OwnerID(),"Range","Lua_Az133_Statue4",100)
end

function Lua_Az133_Statue_15()
	SetPlot(OwnerID(),"Range","Lua_Az133_Statue4",150)
end

function Lua_Az133_Statue_10()
	SetPlot(OwnerID(),"touch","Lua_Az133_StatueMove1",50)
end

function Lua_Az133_Statue_12()
	SetPlot(OwnerID(),"touch","Lua_Az133_StatueMove2",50)
end

function Lua_Az133_Statue_16()
	SetPlot(OwnerID(),"Range","Lua_Az133_Statue4",150)
end

function Lua_Az133_Statue_14()
	SetPlot(OwnerID(),"touch","Lua_Az133_Statue3",50)
end

function Lua_Az133_Statue_17()
	SetPlot(OwnerID(),"touch","Lua_Az133_Statue1",50)
end

function Lua_Az133_LightingCould()
	while true do
		sleep(20)
...
function Lua_Az133_Statue_ATT()
	Setplot(OwnerID(),"Range","Lua_Az133_Trap",50)
	while true do
		sleep(10)
...
function Lua_Az133_StatueMove1()
	local RoomID=ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
...
function Lua_Az133_StatueMove2()
	local RoomID=ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
	local PlayerName=GetName(OwnerID())
	local MessageString="[SC_104217_01][$SETVAR1="..PlayerName.."]"
	local MsgStr="[SC_104217_03][$SETVAR1="..PlayerName.."]"
...
function Lua_Az133_Statue3()
	local PlayerName=GetName(OwnerID())
	local MessageString="[SC_104217_01][$SETVAR1="..PlayerName.."]"
	local FlagNum=ReadRoleValue(TargetID(),EM_RoleValue_PID)
	local Guard=CreateObjByFlag(104216,780717,FlagNum+4,1)
...
function Lua_Az133_Statue4()
	setplot(TargetID(),"range","Lua_Az133_Empty",0)
	local PlayerName=GetName(OwnerID())
	local RoomID=ReadRoleValue(TargetID(),EM_RoleValue_RoomID)
...
function Lua_Az133_Empty()
end

function Lua_Az133_Trap()
	ScriptMessage(OwnerID(),-1,2,"[SC_104217_08]",2)
end

function Lua_Az133_Monkey()
	--say(OwnerID(),"111")
	--say(TargetID(),"222")
	local pos=ReadRoleValue(OwnerID(),EM_RoleValue_PID)
	local RoomID=ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
	local MonkeyKing=CreateObjByFlag(104236,780718,pos,1)
	local RoomID=ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
...
function Lua_Az133_Monkey_0()
	WriteRoleValue(OwnerID(),EM_RoleValue_PID,0)
	SetPlot(OwnerID(),"dead","Lua_Az133_Monkey",10)
end

function Lua_Az133_Monkey_1()
	WriteRoleValue(OwnerID(),EM_RoleValue_PID,1)
	SetPlot(OwnerID(),"dead","Lua_Az133_Monkey",10)
end

function Lua_Az133_Monkey_2()
	WriteRoleValue(OwnerID(),EM_RoleValue_PID,2)
	SetPlot(OwnerID(),"dead","Lua_Az133_Monkey",10)
end

function Lua_Az133_Monkey_3()
	WriteRoleValue(OwnerID(),EM_RoleValue_PID,3)
	SetPlot(OwnerID(),"dead","Lua_Az133_Monkey",10)
end

function Lua_Az133_FrenzyMonkey()
	local monkey=Lua_DW_CreateObj("obj",104249,OwnerID(),1,1)
	WriteRoleValue(OwnerID(),EM_RoleValue_PID,monkey)
	SetFollow(monkey,OwnerID())
	SetPlot(OwnerID(),"dead","Lua_Az133_MasterDie",0)
end

function Lua_Az133_MasterDie()
...
function Lua_Az133_Gate()
	AddBuff(OwnerID(),507528,0,-1)
	--setplot(OwnerID(),"range","Lua_Az133_GateGuard",100)
	setplot(OwnerID(),"dead","Lua_Az133_GateDead",0)
	while true do
		sleep(10)
		...
		if Hp<=0.99 then
			beginplot(OwnerID(),"Lua_Az133_GateGuard",0)
			break
		end
	end
end

function Lua_Az133_GateGuard()
	setplot(TargetID(),"range","Lua_Az133_Empty",0)
--	setplot(OwnerID(),"dead","Lua_Az133_GateDead",0)
	local RoomID=ReadRoleValue(TargetID(),EM_RoleValue_RoomID)
	...
	local Hp=HpNow/HpMax
	local Mob1=CreateObjByFlag(104308,780729,0,1)
	local Mob2=CreateObjByFlag(104306,780729,1,1)
	local Mob3=CreateOBjByFlag(104307,780729,2,1)
	local Mob4=CreateObjByFlag(104308,780729,3,1)
	local mobs={}
	--say(TargetID(),"111")
	...
	ScriptMessage(Mob1,0,0,"[SC_104217_21]",2)
...
--			say(OwnerID(),"wave="..wave)
			wave=9
			Mob2=CreateObjByFlag(104306,780729,1,1)
			Mob3=CreateOBjByFlag(104307,780729,2,1)
			AddToPartition(Mob2,RoomID)
			AddToPartition(Mob3,RoomID)
			table.insert(mobs,mob2)
			table.insert(mobs,mob3)
			ScriptMessage(Mob4,0,0,"[SC_104217_32]",2)
		elseif Hp<=0.2 and wave<=7 then
--			say(TargetID(),"20%")
--			say(OwnerID(),"wave="..wave)
			wave=8
			Mob2=CreateObjByFlag(104306,780729,2,1)
			Mob3=CreateOBjByFlag(104307,780729,1,1)
			AddToPartition(Mob2,RoomID)
			AddToPartition(Mob3,RoomID)
			table.insert(mobs,mob2)
			table.insert(mobs,mob3)
			ScriptMessage(Mob4,0,0,"[SC_104217_29]",2)
...
--			say(OwnerID(),"wave="..wave)
			...
			table.insert(mobs,mob2)
			table.insert(mobs,mob3)
			ScriptMessage(Mob4,0,0,"[SC_104217_28]",2)
...
--			say(OwnerID(),"wave="..wave)
			...
			table.insert(mobs,mob2)
			table.insert(mobs,mob3)
			ScriptMessage(Mob4,0,0,"[SC_104217_27]",2)
...
--			say(OwnerID(),"wave="..wave)
			...
			Mob2=CreateObjByFlag(104306,780729,2,1)
			Mob3=CreateOBjByFlag(104307,780729,1,1)
			Mob4=CreateObjByFlag(104308,780729,3,1)
			...
			table.insert(mobs,mob2)
			table.insert(mobs,mob3)
			ScriptMessage(Mob1,0,0,"[SC_104217_26]",2)
...
--			say(OwnerID(),"wave="..wave)
			...
			table.insert(mobs,mob2)
			table.insert(mobs,mob3)
			ScriptMessage(Mob1,0,0,"[SC_104217_25]",2)
...
--			say(OwnerID(),"wave="..wave)
			...
			table.insert(mobs,mob3)
			AddToPartition(Mob3,RoomID)
			ScriptMessage(Mob1,0,0,"[SC_104217_24]",2)
...
--			say(OwnerID(),"wave="..wave)
			...
			AddToPartition(Mob2,RoomID)
			table.insert(mobs,mob2)
			ScriptMessage(Mob1,0,0,"[SC_104217_23]",2)
		elseif Hp<=0.9 and wave<=0 then
--			say(TargetID(),"90%")
--			say(OwnerID(),"wave="..wave)
			wave=1
			ScriptMessage(Mob1,0,0,"[SC_104217_22]",2)
		end
		if checkid(mob1)==true and tgt==0 and wave>1 then
			...
			local gate=CreateObjByFlag(104337,780729,4,1)
			...
			BeginPlot(gate,"Lua_Az133_Gate",0)
			sleep(10)
			Delobj(OwnerID())
		end
...
function Lua_Az133_TouchStone0()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone0",50)
end
function Lua_Az133_Stone0()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_10]",2)
end

function Lua_Az133_TouchStone1()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone1",50)
end
function Lua_Az133_Stone1()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_11]",2)
end

function Lua_Az133_TouchStone2()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone2",50)
end
function Lua_Az133_Stone2()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_12]",2)
end

function Lua_Az133_TouchStone3()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone3",50)
end
function Lua_Az133_Stone3()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_13]",2)
end

function Lua_Az133_TouchStone4()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone4",50)
end
function Lua_Az133_Stone4()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_14]",2)
end

function Lua_Az133_TouchStone5()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone5",50)
end
function Lua_Az133_Stone5()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_15]",2)
end

function Lua_Az133_TouchStone6()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone6",50)
end
function Lua_Az133_Stone6()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_16]",2)
end

function Lua_Az133_TouchStone7()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone7",50)
end
function Lua_Az133_Stone7()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_17]",2)
end

function Lua_Az133_TouchStone8()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone8",50)
end
function Lua_Az133_Stone8()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_18]",2)
end

function Lua_Az133_TouchStone9()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone9",50)
end
function Lua_Az133_Stone9()
	ScriptMessage(TargetID(),OwnerID(),2,"[SC_104217_19]",2)
end

function Lua_Az133_TouchStone10()
	SetCursorType(OwnerID(),3)
	SetPlot(OwnerID(),"touch","Lua_Az133_Stone10",50)
end
function Lua_Az133_Stone10()
