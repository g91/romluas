function SetEq_Knight_Lv30()
	...
	Obj:SetEq( EM_EQWearPos_Gloves , 220298  );
	Obj:SetEq( EM_EQWearPos_Shoes , 220315 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220235  );
	Obj:SetEq( EM_EQWearPos_Pants , 220277 );
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220258 );
	...
	Obj:SetEq( EM_EQWearPos_MainHand, 210324 );
