...
function Cang_mode_check_easy()	---------------------檢查Boss處於哪個模式
...
function Cang_BossAi_Sword_easy()
	...
	while true do
		...
		local SkillLV = {5, 0, 1, 1, 1, 180 , 170 , 170}	--技能等級
		--劍舞,毀滅打擊,幻象招換,能量恐懼,電網凝聚,烈焰之劍,玄冰之劍,雷霆之劍
		...
		--啟動死亡劇情
		SetPlot( OwnerID() , "dead" , "Cang_BossAi_SwordDead_easy" , 1000 )
...
--						GetDistance( ID[i] , OwnerID() ) < 1000 and 
					...
					--BeginPlot(Door , "Cang_BossAi_SwordCraze_easy",0)
					CombatBegin1 = 1
				end	
				...
				if ( HPPercent <= 0.25 ) then	--第三階段判定優先 25趴血量
					if ( HP25 == 0 ) then
						...
						HP25 = 1
						if Count3 == 0 then
							Temp3 = CreateObj( 103260,-399.4, 1700.6, -1334, 90.4 , 1)
							...
							Sleep(10)
							Temp4 = CreateObj( 103261,-87.3, 1488, -1341.5, 90.4, 1)
				...
				if CheckBuff(OwnerID() , Mode1) == true then	--mode1 劍之階段
					...
					if SkillC >= 15 then
						...
						if  GetDistance( Door , OwnerID() ) >= 430 then
							BeginPlot(OwnerID(),"Cang_BossAi_SwordSkillA1_easy",0)	--分身
						elseif  GetDistance( Door , OwnerID() ) < 430 then
							BeginPlot(OwnerID(),"Cang_BossAi_SwordSkillA2_easy",0)	--分身
						end	
						SkillC = 0
					end
					Count1 = 0
				...
				if CheckBuff (OwnerID() , Mode2) == true then	--mode2 能量階段
					if Count1 == 0 then
						Temp1 = CreateObj( 103260,-399.4, 1700.6, -1334, 90.4 , 1)
						...
						BeginPlot(Temp1,"Cang_BossAi_Swordleft_easy",0)		--寫入左手AI
						WriteRoleValue( Temp1 ,EM_RoleValue_PID, OwnerID())	--寫入PID						
						sleep(10)

						Temp2 = CreateObj(103261,-87.3, 1488, -1341.5, 90.4, 1)
						...
						BeginPlot(Temp2,"Cang_BossAi_Swordright_easy",0)		--寫入右手AI
				...
				if CombatBegin1 == 1 then
					...
					Sleep(50)
					--新創BOSS
					local king = Lua_DW_CreateObj( "flag" ,103263, 780420 , 11,1,1)---將Boss生一隻新的
					Sleep(10)					
					DelObj(Door0)
					Delobj(OwnerID())	
				end	
...
function Cang_BossAi_Swordright_easy()

	local SkillID = 493741	-- 招式ID	
	
	local SkillLV = 3 	-- 招式LV
	local SkillA = 0	--計時
	local SkillB = 0
...
function Cang_BossAi_SwordSkillA1_easy()
	...
	Boss1 = CreateObjByFlag( 103262, 780420, 0, 1)	--招換分身
	...
	Boss2 = CreateObjByFlag( 103262, 780420, 1, 1)	--招換分身
	...
	Boss3 = CreateObjByFlag( 103262, 780420, 2, 1)	--招換分身
	...
	Charge1 = CreateObjByFlag( 103265, 780420, 6, 1)	--招換
	...
	Charge2 = CreateObjByFlag( 103265, 780420, 7, 1)	--招換
	...
	Charge3 = CreateObjByFlag( 103265, 780420, 8, 1)	--招換
	...
	if SkillShow == 1 then --12
		...
		Sleep(30)		
		DelObj(Boss3)
		BeginPlot(Boss1, "Cang_BossAi_SwordSkillB_easy",0)
		BeginPlot(Boss2, "Cang_BossAi_SwordSkillC_easy",0)
		Sleep(45)
		DelObj(Boss1)	--刪除
		DelObj(Boss2)	--刪除
		DelObj(Charge1)	--刪除
	...
	elseif	SkillShow == 2 then --23
		...
		DelObj(Boss1)
		BeginPlot(Boss2, "Cang_BossAi_SwordSkillC_easy",0)
		BeginPlot(Boss3, "Cang_BossAi_SwordSkillD_easy",0)
		Sleep(45)
		DelObj(Boss2)	--刪除
		DelObj(Boss3)	--刪除
		DelObj(Charge1)	--刪除
...
function Cang_BossAi_SwordSkillA2_easy()
	...
	Boss1 = CreateObjByFlag( 103262, 780420, 3, 1)	--招換分身
	SetModeEx( Boss1   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Boss1   , EM_SetModeType_Searchenemy, false )--索敵
	AddToPartition( Boss1 , RoomID )				--加入舞台
	SetFightMode ( Boss1 , 0, 1, 0 ,0 )				--戰鬥模式
	
	Boss2 = CreateObjByFlag( 103262, 780420, 4, 1)	--招換分身
	SetModeEx( Boss2   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Boss2   , EM_SetModeType_Searchenemy, false )--索敵
	AddToPartition( Boss2 , RoomID )				--加入舞台
	SetFightMode ( Boss2 , 0, 1, 0 ,0 )				--戰鬥模式
	
	Boss3 = CreateObjByFlag( 103262, 780420, 5, 1)	--招換分身
	SetModeEx( Boss3   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Boss3   , EM_SetModeType_Searchenemy, false )--索敵
	AddToPartition( Boss3 , RoomID )				--加入舞台
	SetFightMode ( Boss3 , 0, 1, 0 ,0 )				--戰鬥模式
...
function Cang_BossAi_SwordSkillB_easy()
	local RoomID = ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
	local Temp = CreateObjByFlag( 103264, 780421, 0, 1)	--招換
	...
	AddBuff( Temp ,506013,1 ,-1 )
	BeginPlot(Temp,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp1 = CreateObjByFlag( 103264, 780421, 1, 1)	--招換
	...
	AddBuff( Temp1 ,506013,1 ,-1 )
	BeginPlot(Temp1,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp2 = CreateObjByFlag( 103264, 780421, 2, 1)	--招換
	...
	AddBuff( Temp2 ,506013,1 ,-1 )
	BeginPlot(Temp2,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp3 = CreateObjByFlag( 103264, 780421, 3, 1)	--招換
	...
	AddBuff( Temp3 ,506013,1 ,-1 )
	BeginPlot(Temp3,"Cang_BossAi_SwordSkillB1_easy",0)
	Sleep(10)
	local Temp4 = CreateObjByFlag( 103264, 780421, 4, 1)	--招換
	...
	AddBuff( Temp4 ,506013,1 ,-1 )
	BeginPlot(Temp4,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp5 = CreateObjByFlag( 103264, 780421, 5, 1)	--招換
	...
	AddBuff( Temp5 ,506013,1 ,-1 )
	BeginPlot(Temp5,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp6 = CreateObjByFlag( 103264, 780421, 6, 1)	--招換
	...
	AddBuff( Temp6 ,506013,1 ,-1 )
	BeginPlot(Temp6,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp7 = CreateObjByFlag( 103264, 780421, 7, 1)	--招換
	...
	AddBuff( Temp7 ,506013,1 ,-1 )
	BeginPlot(Temp7,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp8 = CreateObjByFlag( 103264, 780421, 8, 1)	--招換
	...
	AddBuff( Temp8 ,506013,1 ,-1 )
	BeginPlot(Temp8,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp9 = CreateObjByFlag( 103264, 780421, 9, 1)	--招換
	...
	AddBuff( Temp9 ,506013,1 ,-1 )
	BeginPlot(Temp9,"Cang_BossAi_SwordSkillB1_easy",0)
	return true
end

function Cang_BossAi_SwordSkillB1_easy()
	sleep(100)
	Delobj(OwnerID())
end

function Cang_BossAi_SwordSkillC_easy()

	local RoomID = ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
	local Temp = CreateObjByFlag( 103264, 780421, 10, 1)	--招換
	SetModeEx( Temp   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp ,506013,1 ,-1 )
	BeginPlot(Temp,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp1 = CreateObjByFlag( 103264, 780421, 11, 1)	--招換
	SetModeEx( Temp1  , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp1  , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp1  , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp1  , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp1 ,506013,1 ,-1 )
	BeginPlot(Temp1,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp2 = CreateObjByFlag( 103264, 780421, 12, 1)	--招換分身
	SetModeEx( Temp2   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp2   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp2   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp2   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp2 ,506013,1 ,-1 )
	BeginPlot(Temp2,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp3 = CreateObjByFlag( 103264, 780421, 13, 1)	--招換
	SetModeEx( Temp3   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp3   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp3   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp3   , EM_SetModeType_Mark, false )--標記
	...
	BeginPlot(Temp3,"Cang_BossAi_SwordSkillB1_easy",0)
	Sleep(10)
	local Temp4 = CreateObjByFlag( 103264, 780421, 14, 1)	--招換
	SetModeEx( Temp4   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp4   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp4   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp4   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp4 ,506013,1 ,-1 )
	BeginPlot(Temp4,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp5 = CreateObjByFlag( 103264, 780421, 15, 1)	--招換
	SetModeEx( Temp5   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp5   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp5   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp5   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp5 ,506013,1 ,-1 )
	BeginPlot(Temp5,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp6 = CreateObjByFlag( 103264, 780421, 16, 1)	--招換
	SetModeEx( Temp6   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp6   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp6   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp6   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp6 ,506013,1 ,-1 )
	BeginPlot(Temp6,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp7 = CreateObjByFlag( 103264, 780421, 17, 1)	--招換
	SetModeEx( Temp7   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp7   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp7   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp7   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp7 ,506013,1 ,-1 )
	BeginPlot(Temp7,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp8 = CreateObjByFlag( 103264, 780421, 18, 1)	--招換
	SetModeEx( Temp8   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp8   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp8   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp8   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp8 ,506013,1 ,-1 )
	BeginPlot(Temp8,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp9 = CreateObjByFlag( 103264, 780421, 19, 1)	--招換
	SetModeEx( Temp9   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp9   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp9   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp9   , EM_SetModeType_Mark, false )--標記
...
function Cang_BossAi_SwordSkillD_easy()

	local RoomID = ReadRoleValue(OwnerID(),EM_RoleValue_RoomID)
	local Temp = CreateObjByFlag( 103264, 780421, 20, 1)	--招換
	SetModeEx( Temp   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp ,506013,1 ,-1 )
	BeginPlot(Temp,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp1 = CreateObjByFlag( 103264, 780421, 21, 1)	--招換
	SetModeEx( Temp1  , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp1  , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp1  , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp1  , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp1 ,506013,1 ,-1 )
	BeginPlot(Temp1,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp2 = CreateObjByFlag( 103264, 780421, 22, 1)	--招換分身
	SetModeEx( Temp2   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp2   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp2   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp2   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp2 ,506013,1 ,-1 )
	BeginPlot(Temp2,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp3 = CreateObjByFlag( 103264, 780421, 23, 1)	--招換
	SetModeEx( Temp3   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp3   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp3   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp3   , EM_SetModeType_Mark, false )--標記
	...
	BeginPlot(Temp3,"Cang_BossAi_SwordSkillB1_easy",0)
	Sleep(10)
	local Temp4 = CreateObjByFlag( 103264, 780421, 24, 1)	--招換
	SetModeEx( Temp4   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp4   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp4   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp4   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp4 ,506013,1 ,-1 )
	BeginPlot(Temp4,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp5 = CreateObjByFlag( 103264, 780421, 25, 1)	--招換
	SetModeEx( Temp5   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp5   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp5   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp5   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp5 ,506013,1 ,-1 )
	BeginPlot(Temp5,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp6 = CreateObjByFlag( 103264, 780421, 26, 1)	--招換
	SetModeEx( Temp6   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp6   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp6   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp6   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp6 ,506013,1 ,-1 )
	BeginPlot(Temp6,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp7 = CreateObjByFlag( 103264, 780421, 27, 1)	--招換
	SetModeEx( Temp7   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp7   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp7   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp7   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp7 ,506013,1 ,-1 )
	BeginPlot(Temp7,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp8 = CreateObjByFlag( 103264, 780421, 28, 1)	--招換
	SetModeEx( Temp8   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp8   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp8   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp8   , EM_SetModeType_Mark, false )--標記
	...
	AddBuff( Temp8 ,506013,1 ,-1 )
	BeginPlot(Temp8,"Cang_BossAi_SwordSkillB1_easy",0)
	local Temp9 = CreateObjByFlag( 103264, 780421, 29, 1)	--招換
	SetModeEx( Temp9   , EM_SetModeType_Fight , false )--可砍殺攻擊
	SetModeEx( Temp9   , EM_SetModeType_Strikback, false )--反擊
	SetModeEx( Temp9   , EM_SetModeType_SearchenemyIgnore, false )--被搜尋
	SetModeEx( Temp9   , EM_SetModeType_Mark, false )--標記
...
function Cang_BossAi_SwordDead_easy()
	---死亡紀錄
