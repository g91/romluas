function ic_105641_02()   																	 ---王AI(第10固定狂暴用)
		...
		while 1 do
			...
			if time3>=25 or time3>=5 and time5==1 then---影分身
				...
				if playKKboss==1 then
						...
						BeginPlot(mob1 , "ic_105641_mob44" , 0)
						BeginPlot(mob2 , "ic_105641_mob44" , 0)
						BeginPlot(mob3 , "ic_105641_mob44" , 0)
						SetModeEx( Boss , EM_SetModeType_Move, true) 							---移動
						time3=0
						time5=2
...
function ic_105641_mob44()---影分身技能
...
local mobkk1
	while 1 do
		...
		if time2>=7 and playjob==1 or time2>=7 and playjob==2 or time2>=5 and playjob==3 or time2>=7 and playjob==6 or time2>=7 and playjob==7 or time2>=7 and playjob==10 then --物理職業
			SetModeEx( OwnerID() , EM_SetModeType_Move, false) 							---移動
			CastSpellLV( OwnerID(),AttackTarget, 497605,80)						
			Sleep(20)
			SetModeEx( OwnerID() , EM_SetModeType_Move, true) 							---移動
			time2=0
		elseif 	time2>=7 and playjob==4 or time2>=7 and playjob==5 or time2>=7 and playjob==8 or time2>=7 and playjob==9 then	--法術職業
			SetModeEx( OwnerID() , EM_SetModeType_Move, false) 							---移動
			CastSpellLV( OwnerID(),AttackTarget, 497604,4000)						
			Sleep(20)
			SetModeEx( OwnerID() , EM_SetModeType_Move, true) 							---移動
			time2=0
		end
