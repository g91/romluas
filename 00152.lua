function SetEq_Mage_Lv15()
	...
	Obj:SetEq( EM_EQWearPos_Gloves , 220443  );
	Obj:SetEq( EM_EQWearPos_Shoes , 220470 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220350  );
	Obj:SetEq( EM_EQWearPos_Pants , 220412 );
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220384 );
	...
	Obj:SetEq( EM_EQWearPos_MainHand, 210143 );
