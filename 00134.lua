function SetEq_Ranger_Lv35()
	...
	Obj:SetEq( EM_EQWearPos_Shoes , 220202 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220110  );
	Obj:SetEq( EM_EQWearPos_Pants , 220159 );
	...
	Obj:SetEq( EM_EQWearPos_MainHand, 210094 );
