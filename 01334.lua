...
--建立者  : 活動企劃 潘晉佳
------------------------------------------------------------------------------
--掛在 任務NPC   (4號  FA)  112774  CODE
------------------------------------------------------------------------------
function LuaN_musicfes_112774_range()  
		SetPlot( OwnerID(), "touch", "LuaN_musicfes_112774_sing", 50 );
end
------------------------------------------------------------------------------
function LuaN_musicfes_112774_sing()
	...
	PlaySoundToPlayer( OwnerID() , "sound/sound_new/skill/Music_Festival/scale/4.mp3", false )

		if Qhard01 == true then --Q困難1  9 ,5
			if step11 == true or step10 == true or step09 == true or step07 == true or step06== true or step05== true or step03 == true or step02 == true or step01 == true or step00 == true then
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG04]", C_SYSTEM )--FA~
				Sleep(10) --2秒
				...
				if step08 == true then -- 如果有step 08
					...
					SetFlag( OwnerID()  , 542539 , 1 ) -- 給 Flag Q09
					SetFlag( OwnerID()  , 542538 , 0 ) -- 刪 Flag Q08
				else
		...
		elseif Qhard02 == true then --Q困難2  x
			...
			SetFlag( OwnerID()  , 542541 , 0 ) -- 刪旗標11
			SetFlag( OwnerID()  , 542530 , 1 ) -- 給旗標0
		elseif Qhard03 == true then --Q困難3 5
			if step11 == true or step10 == true or step09 == true or step08 == true or step07 == true or step06 == true or step05 == true or step03 == true or step02 == true or step01 == true or step00 == true then
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG04]", C_SYSTEM )--FA~
				Sleep(10) --2秒
				ScriptMessage( TargetID() , OwnerID() , 1 , "[SC_MUSICFES_SONG_WRONG]", C_SYSTEM )--你答錯囉！請重新來過吧！
				SetFlag( OwnerID()  , 542531 , 0 ) -- 刪旗標1
