function SetEq_Mage_Lv20()
	...
	Obj:SetEq( EM_EQWearPos_Gloves , 220445  );
	Obj:SetEq( EM_EQWearPos_Shoes , 220472 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220352  );
	Obj:SetEq( EM_EQWearPos_Pants , 220414 );
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220386 );
