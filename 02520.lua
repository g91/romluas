...
function sasa_143_walkP1()
	...
	local ObjMatrix ={}
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix( 106346 , Matrix , 1 , 0 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 2 , 1 )
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 2 , 0 )
	ObjMatrix[4] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 2 , -1 )
	ObjMatrix[5] = LuaFunc_CreateNPCByMatrix( 106344 , Matrix , 3 , 0 )
	--ObjMatrix[6] = LuaFunc_CreateNPCByMatrix( 106344 , Matrix , 3 , 0 )
	--ObjMatrix[7] = LuaFunc_CreateNPCByMatrix( 106344 , Matrix , 3 , -1 )

	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix )
	BeginPlot( OwnerID() , "sasa_143_walk01" , 0 )
end
function sasa_143_walk01()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP1" , 0 )
end

--※ 獅心5人團 ※--

function sasa_143_walkP2()
	local dis = 20
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	local ObjMatrix ={}
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix( 106343 , Matrix , 1 , 0 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix( 106342 , Matrix , 2 , 1 )
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix( 106342 , Matrix , 2 , 0 )
	ObjMatrix[4] = LuaFunc_CreateNPCByMatrix( 106342 , Matrix , 2 , -1 )
	ObjMatrix[5] = LuaFunc_CreateNPCByMatrix( 106341 , Matrix , 3 , 0 )
	--ObjMatrix[6] = LuaFunc_CreateNPCByMatrix( 106341 , Matrix , 3 , 0 )
	--ObjMatrix[7] = LuaFunc_CreateNPCByMatrix( 106341 , Matrix , 3 , -1 )

	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix )
	BeginPlot( OwnerID() , "sasa_143_walk02" , 0 )
end
function sasa_143_walk02()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP2" , 0 )
end

--※ 夏多爾5人團 ※--

function sasa_143_walkP3()
	local dis = 10
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	local ObjMatrix ={}
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix( 106346 , Matrix , 1 , 1 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix( 106346 , Matrix , 1 , -1 )
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix( 106344 , Matrix , 3 , 2 )
	ObjMatrix[4] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 3 , 0 )
	ObjMatrix[5] = LuaFunc_CreateNPCByMatrix( 106344 , Matrix , 3 , -2 )
	--ObjMatrix[6] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 5 , 2 )
	--ObjMatrix[7] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 5 , 0 )
	--ObjMatrix[8] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 5 , -2 )

	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix )
	BeginPlot( OwnerID() , "sasa_143_walk03" , 0 )
end
function sasa_143_walk03()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP3" , 0 )
end

--※ 夏多爾5人團 ※--

function sasa_143_walkP4()
	local dis = 20
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	local ObjMatrix ={}
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix( 106346 , Matrix , 1 , 1 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 1 , -1 )
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix( 106344 , Matrix , 2 , 0 )
	ObjMatrix[4] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 3 , 1 )
	ObjMatrix[5] = LuaFunc_CreateNPCByMatrix( 106346 , Matrix , 3 , -1 )

	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix )
	BeginPlot( OwnerID() , "sasa_143_walk04" , 0 )
end
function sasa_143_walk04()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP4" , 0 )
end

--※ MIX 5人團 ※--

function sasa_143_walkP5()
	local dis = 12
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	local ObjMatrix ={}
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix( 106343 , Matrix , 1 , 1 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix( 106346 , Matrix , 1 , -1 )
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix( 106345 , Matrix , 3 , 2 )
	ObjMatrix[4] = LuaFunc_CreateNPCByMatrix( 106341 , Matrix , 3 , 0 )
	ObjMatrix[5] = LuaFunc_CreateNPCByMatrix( 106344 , Matrix , 3 , -2 )

	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix )
	BeginPlot( OwnerID() , "sasa_143_walk05" , 0 )
end
function sasa_143_walk05()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP5" , 0 )
end

--※ 貓咪4人團 ※--

function sasa_143_walkP6()
	local dis = 18
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	local ObjMatrix ={}
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix( 106347 , Matrix , 1 , 0 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix( 106348 , Matrix , 2 , 1 )
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix( 106348 , Matrix , 2 , -1 )
	ObjMatrix[4] = LuaFunc_CreateNPCByMatrix( 106347 , Matrix , 3 , 0 )

	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix )
	BeginPlot( OwnerID() , "sasa_143_walk06" , 0 )
end
function sasa_143_walk06()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP6" , 0 )
end

--※ 貓咪2人團 ※--

function sasa_143_walkP6_1()
	local dis = 18
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	local ObjMatrix ={}
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix( 106347 , Matrix , 1 , 1 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix( 106347 , Matrix , 1 , -1 )

	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix )
	BeginPlot( OwnerID() , "sasa_143_walk06_1" , 0 )
end
function sasa_143_walk06_1()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP6_1" , 0 )
end

--※ 犀牛3人團 ※--

function sasa_143_walkP7()
	local dis = 20
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	local ObjMatrix ={}
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix( 106340 , Matrix , 1 , 0 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix( 106339 , Matrix , 3 , 1 )
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix( 106338 , Matrix , 3 , -1 )

	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix )
	BeginPlot( OwnerID() , "sasa_143_walk07" , 0 )
end
function sasa_143_walk07()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP7" , 0 )
end

--※ 影兵2人團 ※--

function sasa_143_walkP8()
	local dis = 18
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix)
	BeginPlot( OwnerID() , "sasa_143_walk08" , 0 )
end
function sasa_143_walk08()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP8" , 0 )
end

--※ 22號2人團 ※--

function sasa_143_walkP9()
	local dis = 20
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix)
	BeginPlot( OwnerID() , "sasa_143_walk09" , 0 )
end
function sasa_143_walk09()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP9" , 0 )
end

--※ MIX 5人團 ※--(人王篇)

function sasa_143_walkP10()
	local dis = 12
	local count = 5 --陣列的大小，輸入3 會是 3*3 的陣列；不過因為行數必須為奇數，所以輸入 4 會是 5*4 的陣列。
	local checktime = 10 --判斷的時間間距，數值愈低，判斷的頻率愈高，愈自然，但耗的資源也愈多
	local ReviveTime = 600000  --當陣列中的物件全部消失時，進行陣列重置的動作，如果填 -1 ，就會按照 OwnerID() 設定的重生時間重置
	...
	ObjMatrix[1] = LuaFunc_CreateNPCByMatrix( 106343 , Matrix , 1 , 1 )
	ObjMatrix[2] = LuaFunc_CreateNPCByMatrix( 106347 , Matrix , 1 , -1 )
	ObjMatrix[3] = LuaFunc_CreateNPCByMatrix( 106339 , Matrix , 3 , 2 )
	ObjMatrix[4] = LuaFunc_CreateNPCByMatrix( 106344 , Matrix , 3 , 0 )
	ObjMatrix[5] = LuaFunc_CreateNPCByMatrix( 106346 , Matrix , 3 , -2 )

	LuaFunc_NPCWalkByMatrix_2( ObjMatrix , Matrix , dis , count , checktime , circle ) 
	LuaFunc_ResetMatrix( ReviveTime , Matrix )
	BeginPlot( OwnerID() , "sasa_143_walk010" , 0 )
end
function sasa_143_walk010()
	sleep( 10 )
	BeginPlot( OwnerID() , "sasa_143_walkP10" , 0 )
end
...
function sasa_119467_OpenDoor01EZ()						--放在把手1號上
	...
	if PID > 0 then
		...
		local ScriptSet = { "sasa_119467_AIEZ" , "sasa_119467_luck2EZ" , "sasa_119467_luck3EZ" }
...
function sasa_119467_AIEZ()			--第一手把的觸碰
	BeginPlot( TargetID() , "sasa_119467_AI2EZ" , 0)
	SetIdleMotion( TargetID() , ruFUSION_MIME_ACTIVATE_END )			--把手動作
end

function sasa_119467_AI2EZ()
	...
	if IsTwoHand == 0 then		--沒有開門後的手把
		...
		Setplot( hand4 , "touch" , "sasa_119467_hand4EZ" , 30 )
	...
	if IsOpened == 0 then		--門沒有打開才做
		...
		for i=1 , 7 do
			...
			if DoorCounter == 6 then
				...
				--Say ( OwnerID() , "close" )
				DoorCounter = 0
				Setplot( OwnerID() , "touch" , "sasa_119467_AIEZ" , 30 )
...
function sasa_119467_hand4EZ()			--第二手把的觸碰
	...
	BeginPlot( TargetID() , "sasa_119467_hand4_1EZ" , 0)
	SetIdleMotion(TargetID() , ruFUSION_MIME_ACTIVATE_END )			--把手動作
end

function sasa_119467_hand4_1EZ()
	Setplot( OwnerID() , "touch" , "" , 0 )
	...
	if IsOpened == 0 then		--門沒有打開才做
		...
		for i=1 , 7 do
			...
			if DoorCounter == 6 then
				...
				DoorCounter = 0
				Setplot( OwnerID() , "touch" , "sasa_119467_hand4EZ" , 30 )
				SetIdleMotion( OwnerID() , ruFUSION_MIME_IDLE_STAND )	--把手回到初始動作
				--SetIdleMotion( OwnerID() , ruFUSION_MIME_NONE )
				break
			end
...
function sasa_119467_luck2EZ()
	BeginPlot( TargetID() , "sasa_119467_luck2_1EZ" , 0)
	SetIdleMotion( TargetID() , ruFUSION_MIME_ACTIVATE_END )			--把手動作
	WriteRoleValue ( TargetID() , EM_RoleValue_Register10 , OwnerID() ) --玩家
end

function sasa_119467_luck2_1EZ()
	Setplot( OwnerID() , "touch" , "" , 0 )
...
function sasa_119467_luck3EZ()
	BeginPlot( TargetID() , "sasa_119467_luck3_1EZ" , 0)
	SetIdleMotion( TargetID() , ruFUSION_MIME_ACTIVATE_END )			--把手動作
end

function sasa_119467_luck3_1EZ()
	Setplot( OwnerID() , "touch" , "" , 0 )
	local Room = ReadRoleValue( OwnerID() , EM_RoleValue_RoomID )
	--local String = "Worm!"
