function SetEq_Runedancer_Lv70()
	...
	--設定玩家裝備
	Obj:SetEq( EM_EQWearPos_Head , 220341 );
	Obj:SetEq( EM_EQWearPos_Gloves , 220460 );
	Obj:SetEq( EM_EQWearPos_Shoes , 220487 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220372 );
	Obj:SetEq( EM_EQWearPos_Pants , 220434 );
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220401 );
	Obj:SetEq( EM_EQWearPos_Shoulder, 220508 );
