...
--開始倒數
	while 1 do
		if Xtime < 90 then
			if Xtime == 0 then
				LuaZone_SURVIVE_CheckOK(90,90,1)	--倒數系統
			...
			if Xtime == 5 then
				LuaZone_SURVIVE_CheckOK(90,85,1)	--倒數系統
			end
			if Xtime == 10 then
				LuaZone_SURVIVE_CheckOK(90,80,1)	--倒數系統
			end
			if Xtime == 15 then
				LuaZone_SURVIVE_CheckOK(90,75,1)	--倒數系統
			end
			if Xtime == 20 then
				LuaZone_SURVIVE_CheckOK(90,70,1)	--倒數系統
			end
			if Xtime == 25 then
				LuaZone_SURVIVE_CheckOK(90,65,1)	--倒數系統
			end
			if Xtime == 30 then
				LuaZone_SURVIVE_CheckOK(90,60,1)	--倒數系統
			...
			if Xtime == 35 then
				LuaZone_SURVIVE_CheckOK(90,55,1)	--倒數系統
			end
			if Xtime == 40 then
				LuaZone_SURVIVE_CheckOK(90,50,1)	--倒數系統
			end
			if Xtime == 45 then
				LuaZone_SURVIVE_CheckOK(90,45,1)	--倒數系統
			...
			if Xtime == 50 then
				LuaZone_SURVIVE_CheckOK(90,40,1)	--倒數系統
			end
			if Xtime == 55 then
				LuaZone_SURVIVE_CheckOK(90,35,1)	--倒數系統
			end
			if Xtime == 60 then
				LuaZone_SURVIVE_CheckOK(90,30,1)	--倒數系統
			...
			if Xtime == 65 then
				LuaZone_SURVIVE_CheckOK(90,25,1)	--倒數系統
			end
			if Xtime == 70 then
				LuaZone_SURVIVE_CheckOK(90,20,1)	--倒數系統
			end
			if Xtime == 75 then
				LuaZone_SURVIVE_CheckOK(90,15,1)	--倒數系統
			...
			if Xtime == 80 then
				LuaZone_SURVIVE_CheckOK(90,10,1)	--倒數系統
				LuaZone_SURVIVE_CheckOK(10,1,0)	--倒數系統
			end
			if Xtime == 85 then
				LuaZone_SURVIVE_CheckOK(90,5,1)	--倒數系統
			end
			Sleep(10)
			Xtime = Xtime + 1
		else
			...
			if CheckOK == 1 then
				...
				for i=1, 2, 1 do
					...
					if( GetScore( RoomID, i ) >= 2000 ) then
						...
						AddTeamItem( RoomID, i , 542941 , 1 )	--給獲勝旗標
						--2011/08/10 新增旗標..活動需求
						for k=1,2 do
							AddTeamItem( RoomID, k , 545620 , 1 )	--給旗標
						end
