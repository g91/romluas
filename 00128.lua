function SetEq_Ranger_Lv5()
	...
	Obj:SetEq( EM_EQWearPos_Shoes , 220193 );
	Obj:SetEq( EM_EQWearPos_Clothes , 220098  );
	Obj:SetEq( EM_EQWearPos_Pants , 220147 );
	Obj:SetEq( EM_EQWearPos_Back , 0 );
	Obj:SetEq( EM_EQWearPos_Belt , 220126 );
